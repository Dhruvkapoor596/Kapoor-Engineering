  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#050505] text-white overflow-hidden pt-20">
      <div className="absolute inset-0 z-0">
        <Image src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80" alt="Precision Engineering" fill sizes="100vw" priority className="w-full h-full object-cover opacity-30" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full mt-10">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Link href="/products" data-testid="hero-explore-cta" className="group relative bg-[#EAB308] text-black text-sm font-bold px-8 py-4 rounded-full flex items-center justify-center transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(234,179,8,0.4)] uppercase tracking-widest">
            Explore Solutions <ArrowRight className="ml-3 h-4 w-4 group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link href="/contact" data-testid="hero-quote-cta" className="text-white text-sm font-bold px-8 py-4 rounded-full flex items-center justify-center border border-white/20 hover:bg-white hover:text-black transition-all uppercase tracking-widest">
            Get a Quote
          </Link>
        </div>
      </div>
