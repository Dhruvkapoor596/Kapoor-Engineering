    ...
    <div className="min-h-screen bg-[#050505] pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Stagger className="grid md:grid-cols-3 gap-6 mb-32" staggerChildren={0.12}>
          <StaggerItem className="bg-[#EAB308] p-8 md:p-10 rounded-3xl flex flex-col justify-between h-[380px] transform hover:scale-[1.02] transition-transform duration-500">
          ...
          <StaggerItem className="bg-[#0a0a0a] rounded-3xl overflow-hidden relative border border-white/10 h-[380px] group">
            <Image
          ...
          <StaggerItem className="bg-[#0a0a0a] p-8 md:p-10 rounded-3xl border border-white/10 flex flex-col justify-center items-center text-center hover:border-white/30 transition-colors h-[380px]">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          ...
          <Stagger className="grid sm:grid-cols-2 gap-4" staggerChildren={0.1}>
            <StaggerItem className="bg-[#0a0a0a] border border-white/10 p-6 rounded-3xl hover:border-white/20 transition-colors">
        ...
        {/* CTA strip */}
        <Reveal className="bg-[#0a0a0a] border border-white/10 rounded-3xl p-10 md:p-14 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
