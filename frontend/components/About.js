        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <Reveal className="relative z-10">
            ...
            <p className="text-lg text-slate-400 font-light leading-relaxed mb-10">
              Founded in {siteConfig.yearFounded} in Alwar, Rajasthan, {siteConfig.name}{" "}
              has grown from a local workshop into a trusted partner for
              large-scale manufacturing plants. We combine premium iron supply
              with high-precision machining to keep your operations running
              flawlessly.
            </p>
            ...
            <ul className="space-y-4 mb-10">
              {[
                ...
                <Reveal
                  ...
                  delay={0.1 + i * 0.08}
                  key={i}
                  className="flex items-center text-slate-300 font-light text-sm tracking-wide"
                >
                  <CheckCircle2 className="w-5 h-5 text-[#EAB308] mr-4 flex-shrink-0" />{" "}
                  {item}
                </Reveal>
              ))}
            </ul>
          ...
          {/* RIGHT */}
          <Reveal delay={0.15} className="relative mt-10 lg:mt-0 px-4 sm:px-0">
            ...
            <div className="absolute -bottom-6 -left-2 sm:-left-12 bg-[#0a0a0a] border border-white/10 p-8 rounded-3xl shadow-2xl backdrop-blur-md transform hover:-translate-y-2 transition-transform duration-500">
              <h3 className="text-5xl sm:text-6xl font-black text-[#EAB308] tracking-tighter mb-2">
                <CountUp end={years} />+
              </h3>
              ...
              <p className="text-slate-500 text-xs font-light uppercase tracking-widest">
                Trusted Since {siteConfig.yearFounded}
              </p>
            </div>
          </Reveal>
        </div>
